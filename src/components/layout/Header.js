...
export default function Header() {
    ...
    const notLogged =  <React.Fragment>
        ...
        <div style = {barStyle}>
            <div style = {upperStyle}>
                ...
                <div style = {linksStyle}>
                    ...
                    {window.sessionStorage.getItem('userId') !== null ? isLogged : notLogged}
